  ...
  return (
    ...
    <div className="project-container-2">
      ...
      <div className="project-image">
        <p>Why Does It Feel So Right is a music video filmed for Berlin-based Danish singer Sofie Soe. This music video was made in my first year at film university and I was resposible for the production design and post-production color grading.</p>
      </div>
      <a
